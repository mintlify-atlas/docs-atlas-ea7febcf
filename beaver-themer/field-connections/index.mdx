...
description: Learn how to connect dynamic data from WordPress, ACF, WooCommerce, and more to your Themer layouts.
---
...
Furthermore, field connections extend their support to shortcodes, granting you the flexibility to apply them not only within row, column, or module options but also throughout your entire layout wherever text can be inserted. This includes HTML modules or the custom layout option for the Post module.
...
<Note>
The above diagram showcases WordPress, Advanced Custom Fields and WooCommerce as data sources, but field connections can also be used with other supported plugins, such as BigCommerce, Easy Digital Downloads, and The Events Calendar.
</Note>
...
## Data sources and natively supported plugins
...
Field Connection are supported in WordPress Multisite Network installations. However, it is important to be aware that these field connections cannot be used to retrieve data between sub-sites.
