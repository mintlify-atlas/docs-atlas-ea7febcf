...
<Steps>
  <Step title="Open the Libraries App">
    Click on the Libraries App icon in the Assistant sidebar.
  </Step>
...
<Steps>
  <Step title="Select library">
    Select the library you want to add items to.
  </Step>
  ...
  <Step title="Choose content">
    Open the Content tab and choose the content you want to add.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Add media">
    Click Add New and choose Media.
  </Step>
  
  <Step title="Upload or select files">
    Upload new files or select existing images or videos.
  </Step>
...
<Steps>
  ...
  <Step title="Add color">
    Click the Plus (+) icon and select Colors.
  </Step>
...
<Steps>
  ...
  <Step title="Add code">
    Click Add New and choose Code.
  </Step>
  
  <Step title="Name snippet">
  ...
  <Step title="Select extension">
    Select the file extension (for example, .php or .css).
  </Step>
  
  <Step title="Save">
    Add additional snippets if required and click Save.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Add settings">
    Click Add New and select Settings.
  </Step>
  
  <Step title="Choose source">
    Choose the source of the settings:
    - WordPress Customizer (Theme Settings)
  ...
  <Step title="Select and add">
    Select the specific settings you want to save and click Add Settings.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Select library">
    Navigate to the library you want to edit.
  </Step>
...
<Steps>
  ...
  <Step title="Delete">
    Scroll down to the **Danger Zone** section, click the **Delete Library** button in the **Delete this library** section, and confirm the deletion.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Import library">
    Under the Actions section, click Import Library.
  </Step>
  
  <Step title="Choose items">
    Use the dropdown menu to choose which items you'd like to import in bulk.
  </Step>
</Steps>
...
<Steps>
  <Step title="Open Select toolbar">
    Click the **Select** button to open the Select toolbar.
  </Step>
  
  <Step title="Choose items">
    Choose the library items you'd like to work with by clicking each item. You can select multiple items at once.
  </Step>
  
  <Step title="Take action">
    Once your items are selected, use the toolbar actions to either **Import** the selected items to your website, or **Delete** the selected items from the library.
  </Step>
...
<Steps>
  <Step title="Select item">
    Click directly on the library item you want to import, such as a post, color, or code snippet.
  </Step>
...
<Warning>
The Replace Current Page/Post action replaces all content in the posts.
</Warning>
...
<Steps>
  ...
  <Step title="Click avatar">
    Click your avatar in the upper right corner.
  </Step>
  
  <Step title="Launch Cloud">
    Select **Launch Cloud**.
  </Step>
</Steps>

<Note>
Using the **Launch Cloud** option is only possible after you have connected the Assistant plugin.
</Note>
...
<Warning>
If you are disconnected from the Assistant Pro cloud, the Library App will be unable to access libraries, and you will need to reconnect for libraries to display.
</Warning>
