---
title: Renew license
description: Learn how to renew your Beaver Builder license, manage auto-renewal, and understand renewal discounts for legacy plans.
---
...
<Note>
You can view your subscription renewal date by logging into your Beaver Builder [My Account page](https://www.wpbeaverbuilder.com/my-account/).
</Note>

## Cancel automatic renewal

If you cancel autorenewal, you will need to manually renew your subscription each year. You can cancel autorenewal at any time from your account page:

<Steps>
  <Step title="Access your account">
    Go to your [My Account](https://www.wpbeaverbuilder.com/my-account/) page and scroll to the **My Subscriptions** section
  </Step>
  
  <Step title="Cancel renewal">
    Click the **Cancel Renewal** button next to the subscription you'd like to cancel
  </Step>
</Steps>
