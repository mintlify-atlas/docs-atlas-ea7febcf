...
description: Step-by-step instructions for installing and activating Beaver Builder on your WordPress site.
---
...
This is easy to fix by disabling a preference in Safari, either temporarily or permanently:
...
<Steps>
  <Step title="Access plugins page">
  ...
  <Step title="Select file">
    Click **Browse** and select the downloaded zip file on your local system.
  </Step>
  <Step title="Install">
  ...
  <Step title="Activate">
    If you're doing a fresh installation of any premium version, click **Activate** to activate the plugin.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Access License tab">
    Click the **License** tab.
  </Step>
  <Step title="Enter license key">
    For new installations, add your license key, which you can find on the [My Account](https://www.wpbeaverbuilder.com/my-account/) page.
