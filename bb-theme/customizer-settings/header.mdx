---
title: Header tab in Customizer
description: Configure top bar, header layout, logo, and navigation menu settings for your BB Theme site.
---
...
If you select **Social icons**, configure the icons at **Customize > General > Social links**.
...
The maximum width of the content is controlled by the Content width setting in **Customize > General > Layout**.
...
![Nav bottom layout on desktop](/img/customizer-settings-the-header-tab-0a513d62.png)

Here's the default Nav Bottom layout on medium devices:

![Nav bottom layout on medium devices](/img/customizer-settings-the-header-tab-f17b82f9.png)
...
![Nav bottom layout on mobile](/img/customizer-settings-the-header-tab-7cffb1da.png)
...
![Nav right layout](/img/customizer-settings-the-header-tab-174bd749.png)
...
![Nav right on medium devices](/img/customizer-settings-the-header-tab-10e5a928.png)
...
![Nav centered layout](/img/customizer-settings-the-header-tab-8e143168.png)
...
![Nav centered with inline logo](/img/customizer-settings-the-header-tab-5fa5769c.png)
...
![Vertical navigation](/img/customizer-settings-the-header-tab-ceb06eb7.jpg)
...
You can set text color, link color, and hover color. These color settings apply to:
...
You can set a different header logo image for mobile devices in the **Mobile header logo** field. By default, the max-width breakpoint for mobile devices is 768px.
...
Choose the **Menu button** or **Hamburger icon** to appear when the screen width goes below the responsive nav breakpoint.
...
![Submenu indicator](/img/customizer-settings-the-header-tab-8963625b.png)

### Nav background and text color

When the header layout puts the menu below the header logo area (Nav Centered or Nav Bottom), you can select:
